...
- [x] **13 — Les sept cas de validation.** [MODELE-DE-DOMAINE.md](./MODELE-DE-DOMAINE.md) §12, un test par cas, **plus le huitième** (Pokémon Rouge, trois entités pour un souvenir). *Acceptation : les huit se rejouent et produisent l'état attendu. C'est la porte elle-même.*
