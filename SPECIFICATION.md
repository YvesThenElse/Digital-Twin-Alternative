...
>
> Côté données, la conséquence est chiffrée : les trois régions se valent, donc aucune ne peut être traitée comme un repli de l'autre. L'estimation initiale — de l'ordre de **400 arbitrages** — reposait sur une couverture régionale de 56 %. Après l'ajout de Wikipédia puis la correction de l'analyseur d'infobox, il en reste **57** (27 NTSC-J, 22 PAL, 8 NTSC-U), contre les 16 qu'aurait demandés un périmètre PAL. Le surcoût de la cible internationale est donc réel mais d'un ordre de grandeur inférieur à ce qu'on croyait.
...
| ~~4~~ | ~~**Marché visé : francophone ou international ?**~~ — ✅ **tranchée le 20 septembre 2026 : international dès le départ** | Les trois régions se valent. Conséquences mesurées : l'effort de curation régionale passe de 16 à **57 arbitrages** sur le dataset POC — estimé à 400 avant que l'extraction Wikipédia ne soit corrigée ([dataset/README.md](./dataset/README.md)), et §20 niveau 2 cesse d'être une recommandation — **aucun libellé en dur dès la Phase 1** |
